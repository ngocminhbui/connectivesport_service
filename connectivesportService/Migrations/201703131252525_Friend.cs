    ...
    public partial class Friend : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        AcceptUserId = c.String(nullable: false, maxLength: 128),
                ...
                .ForeignKey("dbo.Users", t => t.RequestUserId)
        ...
        {
            DropForeignKey("dbo.Friends", "RequestUserId", "dbo.Users");
            DropForeignKey("dbo.Friends", "AcceptUserId", "dbo.Users");
            DropIndex("dbo.Friends", new[] { "CreatedAt" });
            DropIndex("dbo.Friends", new[] { "AcceptUserId" });
